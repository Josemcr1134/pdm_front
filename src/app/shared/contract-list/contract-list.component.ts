...
export class ContractListComponent implements OnInit {
  ...
  getContracts(event:boolean = false){
    this.isLoading = !this.isLoading;
    this.pdmSvc.getContracts(this.contractsLimit, this.contractsOffset,this.yearSelected, '' ,this.operatingExpenseId)
        .subscribe({
            error:(err:any) => {
              console.log(err);
              this.isLoading = !this.isLoading;
  ...
  getSourceFinancing(){
    ...
    this.sourceFinancingSvc.getSourceFinancingByExpense( this.yearSelected, this.operatingExpenseId)
          .subscribe({
            error:(err:any) => {
              this.alertSvc.handleErrors(err);
            },
